...
It uses the loss function of [[Log Loss]] 
![[log_reg_1.jpeg]]
...
![[log_reg_convexity_3.jpeg]]

[[Gradient Descent]] is the most known optimisation routine but in Logistic Regression we dont use Gradient Descent but instead use **LBFGS** 
